...
Features: Drag & drop files, download from URLs, queue save/share support, **LHA archive extraction**, dual-file module support (e.g., TFMX, RJP), convert to WAV/FLAC, format auto-detection
...
**Current Stable version:** `uade-cli:3.05-base.3`
...
docker compose -f docker-compose.yml -f docker-compose.dev.yml up -d --build uade-web # For containerized development with hot reload
```
