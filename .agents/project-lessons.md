...
- **Filesystem Pins:** `gcsfs==2026.5.0` rejects `fsspec==2026.4.0`, while `s3fs==2026.4.0` requires `fsspec==2026.4.0`. Hold `gcsfs` at `2026.4.0` until a compatible `fsspec`/`s3fs` release set is available.
